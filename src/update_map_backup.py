...
data_map = {
    ...
    'stn' : {
        'data-name': 'สตูล',
        'data-summary' : 'อุทยานธรณีโลกสตูลได้ประกาศเป็นอุทยานธรณีท้องถิ่น เมื่อวันที่ ๑๔ สิงหาคม พ.ศ. ๒๕๕๗ ครอบคลุมพื้นที่ ๔ อำเภอ ได้แก่ อำเภอทุ่งหว้า อำเภอมะนัง อำเภอละงู และอำเภอเมืองสตูล (อุทยานแห่งชาติตะรุเตา) รวมพื้นที่ ๒,๕๙๗ ตารางกิโลเมตร',
        'data-museum' : '-',
